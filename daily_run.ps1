...
python main.py -d $sig_date orders --sec opn # convert trades to orders with price
python main.py -d $sig_date orders --sec cls # convert trades to orders with price
