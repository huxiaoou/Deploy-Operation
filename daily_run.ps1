...
python main.py -d $sig_date orders --sec opn --type last # convert trades to orders with price
python main.py -d $sig_date orders --sec cls --type last # convert trades to orders with price
