...
def send_orders(
    ...
    if sec_type == "opn":
        attachments = [
            CAttachmentText(orders_file_name_tmpl.format(sig_date, sig_date, sec_type, "pm"), d),
            CAttachmentText(orders_file_name_tmpl.format(sig_date, exe_date, sec_type, "am"), d),
        ]
    elif sec_type == "cls":
        attachments = [
            CAttachmentText(orders_file_name_tmpl.format(sig_date, exe_date, sec_type, "pm"), d),
        ]
    else:
